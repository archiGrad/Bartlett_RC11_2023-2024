...
\keywords{-5}{-4cm}{16cm}{node, houdini, procedural, \footnote{Eproceduralism, attribute, geometry, vop, vex,}
...
\begin{multicols}{2} % Specify the number of columns
 ...
 \noindent   \includegraphics[width=\linewidth]{sections/assignment_1/t.png} % Adjust width as needed


	\begin{figure}[H] % "H" forces the figure to be placed "exactly here"
	    \centering
	    \includegraphics[width=\linewidth]{example-image} % Adjust the image path and width as needed
...
\keywords{-1}{-4cm}{15cm}{Keyword 1, Keyword 2, Keyword 3}




%\noindent \includegraphics[width=\linewidth, h]{sections/assignment_1/t.png}
